...
export default function About({ isDarkMode, isSongPlaying }: { isDarkMode: boolean; isSongPlaying: boolean }) {
  ...
  const skillGroups = [
    { label: "Programming Languages", items: ["Python", "C", "C++", "Java"] },
    { label: "Web & AI", items: ["Flask", "REST APIs", "LangChain", "Agentic AI LLMs", "Spring Boot"] },
    { label: "Cloud & Tooling", items: ["AWS", "Docker", "Kubernetes", "CI/CD", "CMake", "Git"] },
    { label: "Databases", items: ["PostgreSQL", "MongoDB", "RDS", "DynamoDB", "SQS"] }
  ];
  ...
  return (
    ...
    >
              ...
              <div className="flex flex-col sm:flex-row gap-8 lg:gap-12">
                <div className="w-full max-w-xl xl:max-w-2xl 2xl:max-w-3xl">
                  <p className={`text-xl lg:text-2xl font-black italic mb-4 flex items-center gap-3 ${
                      ...
                      <span className="w-8 h-8 rounded-full bg-yellow-400 flex items-center justify-center text-black not-italic text-sm">A</span>
                      Arnav Purushotam
                  </p>
                  <div className={`text-base lg:text-lg leading-relaxed font-medium space-y-4 ${
                    ...
                    <p>
                      M.S. Computer Science candidate at the University of Colorado Boulder (GPA 3.9/4.0) focused on scalable backend systems and applied AI.
                    </p>
                    <p>
                      At CU BioFrontiers, I build software for research workflows, including LLM-powered systems that connect multiple data sources for faster scientific analysis.
                    </p>
                    <p>
                      Built a cloud scheduling pipeline for 200 CU Stores employees on AWS, cutting end-to-end schedule generation to about 5 minutes per run.
                    </p>
                    <p>
                      Contributed to curl/libcurl with upstream C portability fixes, warning cleanups across compilers, and public API hardening for 32/64-bit consistency.
                    </p>
                    <p>
                      Built and shipped distributed systems projects spanning modern C++, Spring microservices, FastAPI orchestration, and observability-first cloud deployments.
                    </p>
                    <p>
                      I care about production reliability, clean architecture, and turning complex ideas into systems teams can operate confidently.
                    </p>
                  </div>
                </div>
                ...
                <div className="flex flex-row lg:flex-col gap-8 lg:gap-6 border-l lg:border-l-2 border-white/10 pl-6">
                    <div className="flex flex-col">
                        <span className="text-3xl lg:text-4xl font-black text-yellow-400">02+</span>
                        <span className="text-[10px] uppercase font-bold opacity-40">Years Exp</span>
                    </div>
                    <div className="flex flex-col">
                        <span className="text-3xl lg:text-4xl font-black text-yellow-400">06+</span>
      ...
      <div className="absolute bottom-6 left-6 right-6 hidden xl:flex items-center justify-between z-20 opacity-20 pointer-events-none select-none">
         <div className="text-[10px] font-black uppercase tracking-[0.5em]">Scalable Systems</div>
         <div className="h-[1px] flex-grow mx-10 bg-white/20" />
         <div className="text-[10px] font-black uppercase tracking-[0.5em]">Research To Production</div>
      </div>
      ...
      <div className="absolute top-1/2 left-0 w-full -translate-y-1/2 pointer-events-none select-none z-[-1] overflow-hidden">
          ...
          >
            {isSongPlaying ? "CODE. BUILD. SHIP." : "DISTRIBUTED SYSTEMS"}
          </motion.h1>
      </div>
    </section>
  );
